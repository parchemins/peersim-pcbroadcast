 ...
 * 
 */
public class PreventiveCausalBroadcast implements EDProtocol, CDProtocol {
	...
	public PreventiveCausalBroadcast(String prefix) {
		PreventiveCausalBroadcast.pid = Configuration.getPid(prefix + "." + PreventiveCausalBroadcast.PAR_PID);
		PreventiveCausalBroadcast.pmessage = Configuration.getDouble(prefix + "." + PreventiveCausalBroadcast.PAR_PMESSAGE,
				0.);
	...
	public PreventiveCausalBroadcast() {
		this.received = new VVwE();
		this.buffers = new HashMap<Node, ArrayList<MReliableBroadcast>>();
	}
	...
	public void nextCycle(Node node, int protocolId) {
		...
		if (CommonState.r.nextDouble() < PreventiveCausalBroadcast.pmessage) {
			// (TODO)
		}
	}
	...
	@Override
	public Object clone() {
		return new PreventiveCausalBroadcast();
	}
